      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".button_14{background-image: url(\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpWN_GZLJ6HYcGa8XOeMXp_6T8i-0iekMcf-NwEtx6kQ&s\");background-size: cover;background-position: center top;}");
           ...
           /*
            ...
            // Display current state, and ON/OFF buttons for GPIO 14  
            client.println("<div><p>Garden - State " + output14State + "</p>");
            // If the output14State is off, it displays the ON button       
            if (output14State=="off") {
                client.println("<p><a href=\"/14/on\"><button class=\"button\">Garden</button></a></p>");
            } else {
                client.println("<p><a href=\"/14/off\"><button class=\"button button2\">Garden</button></a></p></div></div>");
            }*/
            ...
            // Display current state, and ON/OFF buttons for GPIO 32 and 14 in the same line
            ...
            // Display current state, and ON/OFF buttons for GPIO 14
            client.println("</div><div class=\"gpio\"><p>Garden - State " + output14State + "</p>");
            // If the output14State is off, it displays the ON button       
            if (output14State=="off") {
              client.println("<p><a href=\"/14/on\"><button class=\"button_14\"></button></a></p>");
            } else {
              client.println("<p><a href=\"/14/off\"><button class=\"button_14 button2\"></button></a></p>");
            }
            client.println("</div></div>");
